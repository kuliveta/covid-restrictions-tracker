...
public class General {
    ...
    public static void getInputAboutBusinessType() {
        ...
        if (numberOfTypeOfBusiness > corporateBusinessType.size() || numberOfTypeOfBusiness == 0) {
        ...
        switch (numberOfTypeOfBusiness) {
            case 1:
                Retail.restrictionsToRetail();
                break;
            case 2:
                Catering.restrictionsToCatering();
                break;
            case 3:
                Service.restrictionsToServices();
                break;
            case 4:
                Events.restrictionsForEvents();
                break;
        }
    }
    ...
    public static void welcomeMessageToUser() {
        System.out.println("\nHello! Welcome to our Covid restrictions tracker for corporate usage!\n" +
                ...
                "decisions to stop Covid 19 spreading in our country.\n\nPlease follow upcoming instructions! At first you should enter the number that corresponds to your business type on the list below:");
    }
    ...
    public static void wrongNumberMessage() {
        System.out.println("Sorry, number you have entered is out of provided scope.");
    }
    ...
    public static void ifToTryOneMoreTime() {
        ...
        if (tryOneMoreTime.equalsIgnoreCase("yes")) getInputAboutBusinessType();
